...
typedef NS_ENUM (NSUInteger, CMChartFormatType) {
    CMChartFormatTypePercent,
    CMChartFormatTypeDollar,
    CMChartFormatTypeNone,
    CMChartFormatTypeDecimal,
    CMChartFormatTypeDecimalTwoPlaces,
};
...
@property (nonatomic) CMChartFormatType chartType;
