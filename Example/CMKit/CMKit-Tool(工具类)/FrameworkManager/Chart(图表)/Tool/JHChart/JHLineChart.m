...
- (void)handlePan:(UIGestureRecognizer *)recognizer {
    ...
    if (!_touchNumLable) {
        ...
        _touchNumLable.textColor = [UIColor colorForColorString:@"666666"];
...
//    NSValue *lastValue = _firstDataArray.lastObject;
    ...
    CGSize size = [_touchNumLable.text sizeWithFont:[UIFont systemFontOfSize:11] maxSize:CGSizeMake(MAXFLOAT, H)];

    _touchFlowLineView.x = _touchedDot.x;
    _touchNumLable.x = _touchedDot.x - size.width/2;
    _touchNumLable.y = _touchedDot.y - H + 5;
