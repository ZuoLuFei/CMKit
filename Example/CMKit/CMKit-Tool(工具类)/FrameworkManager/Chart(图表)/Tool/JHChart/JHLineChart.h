...
/** 渐变色 */
@property (strong, nonatomic) NSArray * gradientColor;

/** 竖直线颜色 */
@property (strong, nonatomic) UIColor *touchFlowLineColor;

/** 提示文字前缀 */
@property (copy, nonatomic) NSString *touchNumPrefixStr;

/** 提示文字前缀 */
@property (copy, nonatomic) NSString *touchNumSuffixStr;
