...
@interface CMICarouselSampleController ()<iCarouselDataSource, iCarouselDelegate,UIActionSheetDelegate>
...
@implementation CMICarouselSampleController
@synthesize carousel;
@synthesize navItem;
